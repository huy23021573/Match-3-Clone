...
public class Board : MonoBehaviour
{
    ...
    {
        if (allDots[column, row].GetComponent<Dot>().isMatched && allDots[column, row] != null)
        {
            ...
            {
                soundManager.PlayRandomDestroyMusic();
            }
